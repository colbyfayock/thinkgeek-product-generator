...
const defaultImage = { url: 'https://web.archive.org/web/20150404213211im_/http://a.tgcdn.net/images/products/frontsquare/iljk_encounter_wearable_quest.jpg' }
const defaultProductTitle = 'ThinkGeek Product Synthesizer';
const defaultProductTagline = 'The product is... for lack of a better word... perfect!';
const defaultProductDescriptionLong = 'asdf';
const defaultProductDescriptionBullets = ['Product Bullet'];
const defaultProductSpecifications = ['Product Spec'];
const defaultMetaDescription = 'asdf';
const defaultOgDescription = 'asdf';
